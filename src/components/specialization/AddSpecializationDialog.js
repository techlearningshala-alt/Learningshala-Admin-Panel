...
import { addSpecialization, updateSpecializations, fetchSpecialization, findAllCourseName } from "@/lib/menuApi";
...
export default function AddCourseDialog({ item, open, onOpenChange }) {
  ...
  console.log(courses, "ddd")

  // Mutation for Add/Edit Spe.
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>{item ? "Edit Specialization" : "Add New Specialization"}</DialogTitle>
        </DialogHeader>
        ...
        <form className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <select
              {...register("course_id", { required: "specialization is required" })}
